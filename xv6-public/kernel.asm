...
80100028:	bc a0 61 11 80       	mov    $0x801161a0,%esp
...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 87 7e 10 80 	movl   $0x80107e87,(%esp)
...
80100dcd:	e8 ae 5d 00 00       	call   80106b80 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 86 61 00 00       	call   80106f60 <freevm>
  return 0;
...
80100e20:	e8 fb 36 00 00       	call   80104520 <initlock>
}
...
80100e71:	e8 1a 38 00 00       	call   80104690 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 01 38 00 00       	call   80104690 <release>
}
...
80100eaf:	e8 3c 38 00 00       	call   801046f0 <acquire>
  if(f->ref < 1)
...
80100ecc:	e8 bf 37 00 00       	call   80104690 <release>
  return f;
}
...
80100f01:	e8 ea 37 00 00       	call   801046f0 <acquire>
  if(f->ref < 1)
...
80100f39:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f3c:	e8 4f 37 00 00       	call   80104690 <release>
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 1d 37 00 00       	jmp    80104690 <release>
...
80101325:	e8 86 34 00 00       	call   801047b0 <memset>
  log_write(bp);
...
8010136a:	e8 81 33 00 00       	call   801046f0 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
801013d7:	e8 b4 32 00 00       	call   80104690 <release>
...
80101402:	89 43 08             	mov    %eax,0x8(%ebx)
      release(&icache.lock);
80101405:	e8 86 32 00 00       	call   80104690 <release>
      return ip;
...
80101541:	e8 0a 33 00 00       	call   80104850 <memmove>
  brelse(bp);
...
80101576:	e8 a5 2f 00 00       	call   80104520 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 5c 2e 00 00       	call   801043f0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 8f 32 00 00       	call   80104850 <memmove>
  brelse(bp);
...
8010168e:	e8 1d 31 00 00       	call   801047b0 <memset>
      dip->type = type;
...
80101731:	e8 1a 31 00 00       	call   80104850 <memmove>
  log_write(bp);
...
8010175f:	e8 8c 2f 00 00       	call   801046f0 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010176f:	e8 1c 2f 00 00       	call   80104690 <release>
}
...
801017a2:	e8 89 2c 00 00       	call   80104430 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 33 30 00 00       	call   80104850 <memmove>
    brelse(bp);
...
80101873:	e8 58 2c 00 00       	call   801044d0 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 fc 2b 00 00       	jmp    80104490 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 6b 2b 00 00       	call   80104430 <acquiresleep>
...
801018da:	e8 b1 2b 00 00       	call   80104490 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801018e6:	e8 05 2e 00 00       	call   801046f0 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 8b 2d 00 00       	jmp    80104690 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 f9 10 80       	push   $0x8010f960
80101910:	e8 db 2d 00 00       	call   801046f0 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010191f:	e8 6c 2d 00 00       	call   80104690 <release>
    if(r == 1){
...
80101a23:	e8 a8 2a 00 00       	call   801044d0 <holdingsleep>
...
80101a3a:	e8 51 2a 00 00       	call   80104490 <releasesleep>
  iput(ip);
...
80101b37:	e8 14 2d 00 00       	call   80104850 <memmove>
    brelse(bp);
...
80101c33:	e8 18 2c 00 00       	call   80104850 <memmove>
    log_write(bp);
...
80101cce:	e8 ed 2b 00 00       	call   801048c0 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 8e 2b 00 00       	call   801048c0 <strncmp>
      continue;
...
80101dba:	e8 31 29 00 00       	call   801046f0 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101dca:	e8 c1 28 00 00       	call   80104690 <release>
...
80101e27:	e8 24 2a 00 00       	call   80104850 <memmove>
...
80101e8c:	e8 3f 26 00 00       	call   801044d0 <holdingsleep>
...
80101eae:	e8 dd 25 00 00       	call   80104490 <releasesleep>
  iput(ip);
...
80101edb:	e8 70 29 00 00       	call   80104850 <memmove>
    name[len] = 0;
...
80101f2b:	e8 a0 25 00 00       	call   801044d0 <holdingsleep>
...
80101f4a:	e8 41 25 00 00       	call   80104490 <releasesleep>
  iput(ip);
...
80101f6d:	e8 5e 25 00 00       	call   801044d0 <holdingsleep>
...
80101f90:	e8 3b 25 00 00       	call   801044d0 <holdingsleep>
...
80101fa7:	e8 e4 24 00 00       	call   80104490 <releasesleep>
}
...
8010203d:	e8 ce 28 00 00       	call   80104910 <strncpy>
...
80102088:	68 6e 7c 10 80       	push   $0x80107c6e
...
801021d0:	e8 4b 23 00 00       	call   80104520 <initlock>
...
8010224e:	e8 9d 24 00 00       	call   801046f0 <acquire>
...
801022cb:	e8 c0 23 00 00       	call   80104690 <release>
...
801022ee:	e8 dd 21 00 00       	call   801044d0 <holdingsleep>
...
80102328:	e8 c3 23 00 00       	call   801046f0 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 05 23 00 00       	jmp    80104690 <release>
...
801024d2:	81 fb a0 61 11 80    	cmp    $0x801161a0,%ebx
...
801024f2:	e8 b9 22 00 00       	call   801047b0 <memset>
...
80102625:	e8 f6 1e 00 00       	call   80104520 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 38 20 00 00       	call   801046f0 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 aa 1f 00 00       	call   80104690 <release>
  return (char*)r;
...
80102af7:	e8 04 1d 00 00       	call   80104800 <memcmp>
...
80102c24:	e8 27 1c 00 00       	call   80104850 <memmove>
...
80102cd4:	e8 47 18 00 00       	call   80104520 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 80 19 00 00       	call   801046f0 <acquire>
...
80102dbc:	e8 cf 18 00 00       	call   80104690 <release>
      break;
    }
  }
}
...
80102dde:	e8 0d 19 00 00       	call   801046f0 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 6f 18 00 00       	call   80104690 <release>
}
...
80102e36:	e8 b5 18 00 00       	call   801046f0 <acquire>
    wakeup(&log);
...
80102e58:	e8 33 18 00 00       	call   80104690 <release>
...
80102eb4:	e8 97 19 00 00       	call   80104850 <memmove>
...
80102f14:	e8 77 17 00 00       	call   80104690 <release>
...
80102f76:	e8 75 17 00 00       	call   801046f0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102fb4:	c9                   	leave  
  release(&log.lock);
80102fb5:	e9 d6 16 00 00       	jmp    80104690 <release>
...
80103022:	e8 59 2a 00 00       	call   80105a80 <idtinit>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 25 3b 00 00       	call   80106b70 <switchkvm>
  seginit();
8010304b:	e8 90 3a 00 00       	call   80106ae0 <seginit>
  lapicinit();
...
80103077:	68 a0 61 11 80       	push   $0x801161a0
8010307c:	e8 8f f5 ff ff       	call   80102610 <kinit1>
  kvmalloc();      // kernel page table
80103081:	e8 da 3f 00 00       	call   80107060 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 4b 3a 00 00       	call   80106ae0 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 c7 2c 00 00       	call   80105d70 <uartinit>
  pinit();         // process table
801030a9:	e8 32 08 00 00       	call   801038e0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 4d 29 00 00       	call   80105a00 <tvinit>
  binit();         // buffer cache
...
801030ca:	68 90 a4 10 80       	push   $0x8010a490
801030cf:	68 00 70 00 80       	push   $0x80007000
801030d4:	e8 77 17 00 00       	call   80104850 <memmove>
...
801031c4:	e8 37 16 00 00       	call   80104800 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 7c 15 00 00       	call   80104800 <memcmp>
...
801033c8:	e8 33 14 00 00       	call   80104800 <memcmp>
...
801034a9:	e8 72 10 00 00       	call   80104520 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 ac 11 00 00       	call   801046f0 <acquire>
  if(writable){
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 07 11 00 00       	jmp    80104690 <release>
80103589:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103590:	83 ec 0c             	sub    $0xc,%esp
80103593:	53                   	push   %ebx
80103594:	e8 f7 10 00 00       	call   80104690 <release>
    kfree((char*)p);
...
801035dd:	e8 0e 11 00 00       	call   801046f0 <acquire>
  for(i = 0; i < n; i++){
...
8010366c:	e8 1f 10 00 00       	call   80104690 <release>
        return -1;
...
801036c2:	e8 c9 0f 00 00       	call   80104690 <release>
  return n;
...
801036e6:	e8 05 10 00 00       	call   801046f0 <acquire>
...
8010377e:	e8 0d 0f 00 00       	call   80104690 <release>
  return i;
...
80103799:	e8 f2 0e 00 00       	call   80104690 <release>
      return -1;
...
801037c1:	e8 2a 0f 00 00       	call   801046f0 <acquire>
...
801037f1:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->tickets = 10;
801037f8:	c7 43 7c 0a 00 00 00 	movl   $0xa,0x7c(%ebx)
  p->pid = nextpid++;
...
8010380a:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103810:	e8 7b 0e 00 00       	call   80104690 <release>
...
80103832:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103835:	c7 40 14 ef 59 10 80 	movl   $0x801059ef,0x14(%eax)
  p->context = (struct context*)sp;
...
80103844:	e8 67 0f 00 00       	call   801047b0 <memset>
...
8010386a:	e8 21 0e 00 00       	call   80104690 <release>
}
...
8010389b:	e8 f0 0d 00 00       	call   80104690 <release>
...
801038e6:	68 60 7a 10 80       	push   $0x80107a60
801038eb:	68 20 1d 11 80       	push   $0x80111d20
801038f0:	e8 2b 0c 00 00       	call   80104520 <initlock>
}
...
80103984:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103987:	e8 14 0c 00 00       	call   801045a0 <pushcli>
  c = mycpu();
8010398c:	e8 6f ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103991:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103997:	e8 54 0c 00 00       	call   801045f0 <popcli>
}
...
801039c3:	e8 18 36 00 00       	call   80106fe0 <setupkvm>
...
801039db:	68 64 a4 10 80       	push   $0x8010a464
801039e0:	50                   	push   %eax
801039e1:	e8 aa 32 00 00       	call   80106c90 <inituvm>
...
801039f6:	e8 b5 0d 00 00       	call   801047b0 <memset>
...
80103a4f:	68 90 7a 10 80       	push   $0x80107a90
80103a54:	50                   	push   %eax
80103a55:	e8 16 0f 00 00       	call   80104970 <safestrcpy>
  p->cwd = namei("/");
80103a5a:	c7 04 24 99 7a 10 80 	movl   $0x80107a99,(%esp)
...
80103a93:	68 77 7a 10 80       	push   $0x80107a77
...
80103aa5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aa8:	e8 f3 0a 00 00       	call   801045a0 <pushcli>
  c = mycpu();
80103aad:	e8 4e fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ab2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ab8:	e8 33 0b 00 00       	call   801045f0 <popcli>
  sz = curproc->sz;
...
80103acb:	e8 b0 30 00 00       	call   80106b80 <switchuvm>
  return 0;
...
80103aea:	e8 11 33 00 00       	call   80106e00 <allocuvm>
...
80103b0a:	e8 21 34 00 00       	call   80106f30 <deallocuvm>
...
80103b26:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b29:	e8 72 0a 00 00       	call   801045a0 <pushcli>
  c = mycpu();
80103b2e:	e8 cd fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b33:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b39:	e8 b2 0a 00 00       	call   801045f0 <popcli>
  if((np = allocproc()) == 0){
...
80103b58:	e8 73 35 00 00       	call   801070d0 <copyuvm>
...
80103c61:	31 d2                	xor    %edx,%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c63:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103c68:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103c6f:	90                   	nop
      if(p->state == RUNNABLE){
80103c70:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103c74:	75 03                	jne    80103c79 <scheduler+0x39>
        tickets_total += p->tickets;
80103c76:	03 50 7c             	add    0x7c(%eax),%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c79:	05 88 00 00 00       	add    $0x88,%eax
80103c7e:	3d 54 3f 11 80       	cmp    $0x80113f54,%eax
80103c83:	75 eb                	jne    80103c70 <scheduler+0x30>
    if(tickets_total > 0){
80103c85:	85 d2                	test   %edx,%edx
80103c87:	7e d7                	jle    80103c60 <scheduler+0x20>
      int winning_ticket = random_at_most(tickets_total - 1);
80103c89:	83 ec 0c             	sub    $0xc,%esp
80103c8c:	83 ea 01             	sub    $0x1,%edx
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c8f:	bf 54 1d 11 80       	mov    $0x80111d54,%edi
      int winning_ticket = random_at_most(tickets_total - 1);
80103c94:	52                   	push   %edx
80103c95:	e8 36 38 00 00       	call   801074d0 <random_at_most>
      acquire(&ptable.lock);
80103c9a:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
      int winning_ticket = random_at_most(tickets_total - 1);
80103ca1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
      acquire(&ptable.lock);
80103ca4:	e8 47 0a 00 00       	call   801046f0 <acquire>
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ca9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
      acquire(&ptable.lock);
80103cac:	83 c4 10             	add    $0x10,%esp
80103caf:	eb 15                	jmp    80103cc6 <scheduler+0x86>
80103cb1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cb8:	81 c7 88 00 00 00    	add    $0x88,%edi
80103cbe:	81 ff 54 3f 11 80    	cmp    $0x80113f54,%edi
80103cc4:	74 45                	je     80103d0b <scheduler+0xcb>
        if(p->state != RUNNABLE){
80103cc6:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103cca:	75 ec                	jne    80103cb8 <scheduler+0x78>
        if(winning_ticket <0){
80103ccc:	2b 47 7c             	sub    0x7c(%edi),%eax
80103ccf:	79 e7                	jns    80103cb8 <scheduler+0x78>
          switchuvm(p);
...
80103cdb:	e8 a0 2e 00 00       	call   80106b80 <switchuvm>
          swtch(&(c->scheduler), p->context);
80103ce0:	58                   	pop    %eax
80103ce1:	5a                   	pop    %edx
80103ce2:	ff 77 1c             	push   0x1c(%edi)
80103ce5:	56                   	push   %esi
          p->ticks++; //increment ticks when process is running
80103ce6:	83 87 84 00 00 00 01 	addl   $0x1,0x84(%edi)
          p->state = RUNNING;
80103ced:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
          swtch(&(c->scheduler), p->context);
80103cf4:	e8 d2 0c 00 00       	call   801049cb <swtch>
          switchkvm();
80103cf9:	e8 72 2e 00 00       	call   80106b70 <switchkvm>
          break;
...
80103d0e:	68 20 1d 11 80       	push   $0x80111d20
80103d13:	e8 78 09 00 00       	call   80104690 <release>
80103d18:	83 c4 10             	add    $0x10,%esp
80103d1b:	e9 40 ff ff ff       	jmp    80103c60 <scheduler+0x20>
...
80103d24:	53                   	push   %ebx
  pushcli();
80103d25:	e8 76 08 00 00       	call   801045a0 <pushcli>
  c = mycpu();
80103d2a:	e8 d1 fb ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103d2f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d35:	e8 b6 08 00 00       	call   801045f0 <popcli>
  if(!holding(&ptable.lock))
80103d3a:	83 ec 0c             	sub    $0xc,%esp
80103d3d:	68 20 1d 11 80       	push   $0x80111d20
80103d42:	e8 09 09 00 00       	call   80104650 <holding>
80103d47:	83 c4 10             	add    $0x10,%esp
80103d4a:	85 c0                	test   %eax,%eax
80103d4c:	74 4f                	je     80103d9d <sched+0x7d>
  if(mycpu()->ncli != 1)
80103d4e:	e8 ad fb ff ff       	call   80103900 <mycpu>
...
80103de6:	83 ec 0c             	sub    $0xc,%esp
  struct proc *curproc = myproc();
80103de9:	e8 92 fb ff ff       	call   80103980 <myproc>
  if(curproc == initproc)
80103dee:	39 05 54 3f 11 80    	cmp    %eax,0x80113f54
...
80103e4a:	e8 a1 08 00 00       	call   801046f0 <acquire>
...
80103e65:	3d 54 3f 11 80       	cmp    $0x80113f54,%eax
...
80103e83:	3d 54 3f 11 80       	cmp    $0x80113f54,%eax
80103e88:	75 e2                	jne    80103e6c <exit+0x8c>
      p->parent = initproc;
80103e8a:	8b 0d 54 3f 11 80    	mov    0x80113f54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103ea6:	81 fa 54 3f 11 80    	cmp    $0x80113f54,%edx
...
80103ecd:	3d 54 3f 11 80       	cmp    $0x80113f54,%eax
...
80103ef7:	68 e8 7a 10 80       	push   $0x80107ae8
80103efc:	e8 7f c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103f01:	83 ec 0c             	sub    $0xc,%esp
80103f04:	68 db 7a 10 80       	push   $0x80107adb
...
80103f32:	e8 b9 07 00 00       	call   801046f0 <acquire>
...
80103f4e:	81 fb 54 3f 11 80    	cmp    $0x80113f54,%ebx
...
80103f67:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f6c:	81 fb 54 3f 11 80    	cmp    $0x80113f54,%ebx
...
80103f81:	0f 85 8f 00 00 00    	jne    80104016 <wait+0x106>
  pushcli();
80103f87:	e8 14 06 00 00       	call   801045a0 <pushcli>
  c = mycpu();
80103f8c:	e8 6f f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103f91:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f97:	e8 54 06 00 00       	call   801045f0 <popcli>
  if(p == 0)
...
80103fd9:	e8 82 2f 00 00       	call   80106f60 <freevm>
        p->pid = 0;
...
80104005:	e8 86 06 00 00       	call   80104690 <release>
        return pid;
...
8010404c:	e8 9f 06 00 00       	call   801046f0 <acquire>
  pushcli();
80104051:	e8 4a 05 00 00       	call   801045a0 <pushcli>
  c = mycpu();
80104056:	e8 a5 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010405b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104061:	e8 8a 05 00 00       	call   801045f0 <popcli>
...
80104079:	e8 12 06 00 00       	call   80104690 <release>
}
...
8010409c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010409f:	e8 fc 04 00 00       	call   801045a0 <pushcli>
  c = mycpu();
801040a4:	e8 57 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801040a9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801040af:	e8 3c 05 00 00       	call   801045f0 <popcli>
  if(p == 0)
...
801040d0:	e8 1b 06 00 00       	call   801046f0 <acquire>
    release(lk);
801040d5:	89 34 24             	mov    %esi,(%esp)
801040d8:	e8 b3 05 00 00       	call   80104690 <release>
  p->chan = chan;
...
801040fa:	e8 91 05 00 00       	call   80104690 <release>
    acquire(lk);
...
8010410b:	5d                   	pop    %ebp
    acquire(lk);
8010410c:	e9 df 05 00 00       	jmp    801046f0 <acquire>
...
80104139:	68 fa 7a 10 80       	push   $0x80107afa
8010413e:	e8 3d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104143:	83 ec 0c             	sub    $0xc,%esp
80104146:	68 f4 7a 10 80       	push   $0x80107af4
...
8010415f:	e8 8c 05 00 00       	call   801046f0 <acquire>
...
80104175:	3d 54 3f 11 80       	cmp    $0x80113f54,%eax
...
80104193:	3d 54 3f 11 80       	cmp    $0x80113f54,%eax
...
801041a4:	c9                   	leave  
  release(&ptable.lock);
801041a5:	e9 e6 04 00 00       	jmp    80104690 <release>
...
801041d5:	3d 54 3f 11 80       	cmp    $0x80113f54,%eax
...
801041fd:	e8 8e 04 00 00       	call   80104690 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104218:	e8 73 04 00 00       	call   80104690 <release>
}
...
8010426f:	74 e7                	je     80104258 <procdump+0x28>
      state = "???";
80104271:	ba 0b 7b 10 80       	mov    $0x80107b0b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104276:	83 f8 05             	cmp    $0x5,%eax
80104279:	77 11                	ja     8010428c <procdump+0x5c>
8010427b:	8b 14 85 6c 7b 10 80 	mov    -0x7fef8494(,%eax,4),%edx
      state = "???";
80104282:	b8 0b 7b 10 80       	mov    $0x80107b0b,%eax
...
80104291:	68 0f 7b 10 80       	push   $0x80107b0f
...
801042b8:	e8 83 02 00 00       	call   80104540 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042cd:	68 61 75 10 80       	push   $0x80107561
...
801042f3:	53                   	push   %ebx
  // Accept pointer to pstat struct as argument
  struct pstat* target;
  if (argptr(0, (void*)&target, sizeof(*target)) < 0)
801042f4:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
801042f7:	83 ec 18             	sub    $0x18,%esp
  if (argptr(0, (void*)&target, sizeof(*target)) < 0)
801042fa:	68 00 04 00 00       	push   $0x400
801042ff:	50                   	push   %eax
80104300:	6a 00                	push   $0x0
80104302:	e8 b9 07 00 00       	call   80104ac0 <argptr>
80104307:	83 c4 10             	add    $0x10,%esp
8010430a:	85 c0                	test   %eax,%eax
8010430c:	78 7f                	js     8010438d <sys_getpinfo+0x9d>
    return -1;

  // Acquire process table lock
  acquire(&ptable.lock);
8010430e:	83 ec 0c             	sub    $0xc,%esp
80104311:	68 20 1d 11 80       	push   $0x80111d20
80104316:	e8 d5 03 00 00       	call   801046f0 <acquire>
8010431b:	83 c4 10             	add    $0x10,%esp

  // Iterate over all processes in the process table and copy process information
  struct proc* p;
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010431e:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80104323:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104327:	90                   	nop
    if (p->state != UNUSED) {
80104328:	8b 50 0c             	mov    0xc(%eax),%edx
8010432b:	85 d2                	test   %edx,%edx
8010432d:	74 3b                	je     8010436a <sys_getpinfo+0x7a>
      const int index = p - ptable.proc;
8010432f:	89 c2                	mov    %eax,%edx
80104331:	8b 5d f4             	mov    -0xc(%ebp),%ebx
      target->pid[index] = p->pid;
80104334:	8b 48 10             	mov    0x10(%eax),%ecx
      const int index = p - ptable.proc;
80104337:	81 ea 54 1d 11 80    	sub    $0x80111d54,%edx
8010433d:	c1 fa 03             	sar    $0x3,%edx
80104340:	69 d2 f1 f0 f0 f0    	imul   $0xf0f0f0f1,%edx,%edx
80104346:	8d 14 93             	lea    (%ebx,%edx,4),%edx
      target->pid[index] = p->pid;
80104349:	89 8a 00 02 00 00    	mov    %ecx,0x200(%edx)
      target->ticks[index] = p->ticks;
8010434f:	8b 88 84 00 00 00    	mov    0x84(%eax),%ecx
80104355:	89 8a 00 03 00 00    	mov    %ecx,0x300(%edx)
      target->tickets[index] = p->tickets;
8010435b:	8b 48 7c             	mov    0x7c(%eax),%ecx
      target->inuse[index] = 1;
8010435e:	c7 02 01 00 00 00    	movl   $0x1,(%edx)
      target->tickets[index] = p->tickets;
80104364:	89 8a 00 01 00 00    	mov    %ecx,0x100(%edx)
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010436a:	05 88 00 00 00       	add    $0x88,%eax
8010436f:	3d 54 3f 11 80       	cmp    $0x80113f54,%eax
80104374:	75 b2                	jne    80104328 <sys_getpinfo+0x38>
    }
  }

  // Release process table lock and return
  release(&ptable.lock);
80104376:	83 ec 0c             	sub    $0xc,%esp
80104379:	68 20 1d 11 80       	push   $0x80111d20
8010437e:	e8 0d 03 00 00       	call   80104690 <release>
  return 0;
...
801043a3:	53                   	push   %ebx
	int n;
	if(argint(0, &n) <0)
801043a4:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
801043a7:	83 ec 1c             	sub    $0x1c,%esp
	if(argint(0, &n) <0)
801043aa:	50                   	push   %eax
801043ab:	6a 00                	push   $0x0
801043ad:	e8 be 06 00 00       	call   80104a70 <argint>
801043b2:	83 c4 10             	add    $0x10,%esp
801043b5:	85 c0                	test   %eax,%eax
801043b7:	78 27                	js     801043e0 <sys_settickets+0x40>
  pushcli();
801043b9:	e8 e2 01 00 00       	call   801045a0 <pushcli>
  c = mycpu();
801043be:	e8 3d f5 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801043c3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801043c9:	e8 22 02 00 00       	call   801045f0 <popcli>
		return -1;
	myproc()->tickets = n;
801043ce:	8b 45 f4             	mov    -0xc(%ebp),%eax
801043d1:	89 43 7c             	mov    %eax,0x7c(%ebx)
	return n;
}
801043d4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801043d7:	c9                   	leave  
801043d8:	c3                   	ret    
801043d9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		return -1;
801043e0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801043e5:	eb ed                	jmp    801043d4 <sys_settickets+0x34>
...
801043fa:	68 84 7b 10 80       	push   $0x80107b84
...
80104463:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104469:	e8 12 f5 ff ff       	call   80103980 <myproc>
...
801044b4:	e8 97 fc ff ff       	call   80104150 <wakeup>
  release(&lk->lk);
...
8010450b:	e8 70 f4 ff ff       	call   80103980 <myproc>
...
801045fb:	75 35                	jne    80104632 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
801045fd:	e8 fe f2 ff ff       	call   80103900 <mycpu>
...
80104635:	68 8f 7b 10 80       	push   $0x80107b8f
8010463a:	e8 41 bd ff ff       	call   80100380 <panic>
    panic("popcli");
8010463f:	83 ec 0c             	sub    $0xc,%esp
80104642:	68 a6 7b 10 80       	push   $0x80107ba6
...
80104673:	e8 88 f2 ff ff       	call   80103900 <mycpu>
...
801046ab:	68 ad 7b 10 80       	push   $0x80107bad
...
8010472c:	e8 cf f1 ff ff       	call   80103900 <mycpu>
...
8010478b:	e8 70 f1 ff ff       	call   80103900 <mycpu>
...
801047a0:	68 b5 7b 10 80       	push   $0x80107bb5
...
80104ac6:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104ac9:	e8 b2 ee ff ff       	call   80103980 <myproc>
80104ace:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ad0:	e8 ab ee ff ff       	call   80103980 <myproc>
...
80104ade:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ae1:	e8 9a ee ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b34:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104b35:	e8 46 ee ff ff       	call   80103980 <myproc>
...
80104b43:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b46:	e8 35 ee ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b5b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104b5e:	e8 1d ee ff ff       	call   80103980 <myproc>
  if(addr >= curproc->sz)
...
80104bb4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104bb7:	e8 c4 ed ff ff       	call   80103980 <myproc>
...
80104bcc:	8b 14 85 e0 7b 10 80 	mov    -0x7fef8420(,%eax,4),%edx
...
80104bf8:	68 bd 7b 10 80       	push   $0x80107bbd
...
80104c37:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104c3a:	e8 81 d4 ff ff       	call   801020c0 <nameiparent>
...
80104c50:	e8 2b cb ff ff       	call   80101780 <ilock>
...
80104c5c:	e8 7f d0 ff ff       	call   80101ce0 <dirlookup>
...
80104c6e:	e8 9d cd ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80104c73:	89 34 24             	mov    %esi,(%esp)
80104c76:	e8 05 cb ff ff       	call   80101780 <ilock>
...
80104ca4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104ca6:	e8 65 cd ff ff       	call   80101a10 <iunlockput>
    return 0;
...
80104cca:	e8 41 c9 ff ff       	call   80101610 <ialloc>
...
80104d01:	e8 ca c9 ff ff       	call   801016d0 <iupdate>
...
80104d18:	e8 c3 d2 ff ff       	call   80101fe0 <dirlink>
...
80104d28:	e8 e3 cc ff ff       	call   80101a10 <iunlockput>
  return ip;
...
80104d49:	e8 82 c9 ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104d4e:	83 c4 0c             	add    $0xc,%esp
80104d51:	ff 76 04             	push   0x4(%esi)
80104d54:	68 64 7c 10 80       	push   $0x80107c64
80104d59:	56                   	push   %esi
80104d5a:	e8 81 d2 ff ff       	call   80101fe0 <dirlink>
...
80104d6c:	68 63 7c 10 80       	push   $0x80107c63
80104d71:	56                   	push   %esi
80104d72:	e8 69 d2 ff ff       	call   80101fe0 <dirlink>
...
80104d81:	68 57 7c 10 80       	push   $0x80107c57
...
80104d9f:	68 66 7c 10 80       	push   $0x80107c66
80104da4:	e8 d7 b5 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104da9:	83 ec 0c             	sub    $0xc,%esp
80104dac:	68 48 7c 10 80       	push   $0x80107c48
...
80104e28:	e8 73 c0 ff ff       	call   80100ea0 <filedup>
  return fd;
...
80104e48:	83 ec 18             	sub    $0x18,%esp
  readcount++;
80104e4b:	83 05 58 3f 11 80 01 	addl   $0x1,0x80113f58
  if(argint(n, &fd) < 0)
80104e52:	53                   	push   %ebx
80104e53:	6a 00                	push   $0x0
80104e55:	e8 16 fc ff ff       	call   80104a70 <argint>
80104e5a:	83 c4 10             	add    $0x10,%esp
80104e5d:	85 c0                	test   %eax,%eax
80104e5f:	78 5f                	js     80104ec0 <sys_read+0x80>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104e61:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104e65:	77 59                	ja     80104ec0 <sys_read+0x80>
80104e67:	e8 14 eb ff ff       	call   80103980 <myproc>
80104e6c:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104e6f:	8b 74 90 28          	mov    0x28(%eax,%edx,4),%esi
80104e73:	85 f6                	test   %esi,%esi
80104e75:	74 49                	je     80104ec0 <sys_read+0x80>
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104e77:	83 ec 08             	sub    $0x8,%esp
80104e7a:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104e7d:	50                   	push   %eax
80104e7e:	6a 02                	push   $0x2
80104e80:	e8 eb fb ff ff       	call   80104a70 <argint>
80104e85:	83 c4 10             	add    $0x10,%esp
80104e88:	85 c0                	test   %eax,%eax
80104e8a:	78 34                	js     80104ec0 <sys_read+0x80>
80104e8c:	83 ec 04             	sub    $0x4,%esp
80104e8f:	ff 75 f0             	push   -0x10(%ebp)
...
80104e9f:	78 1f                	js     80104ec0 <sys_read+0x80>
  return fileread(f, p, n);
80104ea1:	83 ec 04             	sub    $0x4,%esp
80104ea4:	ff 75 f0             	push   -0x10(%ebp)
80104ea7:	ff 75 f4             	push   -0xc(%ebp)
80104eaa:	56                   	push   %esi
80104eab:	e8 70 c1 ff ff       	call   80101020 <fileread>
...
80104ec5:	eb ec                	jmp    80104eb3 <sys_read+0x73>
...
80104ede:	e8 8d fb ff ff       	call   80104a70 <argint>
...
80104f09:	e8 62 fb ff ff       	call   80104a70 <argint>
...
80104f1e:	e8 9d fb ff ff       	call   80104ac0 <argptr>
...
80104f5e:	e8 0d fb ff ff       	call   80104a70 <argint>
...
80104f81:	74 25                	je     80104fa8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104f83:	e8 f8 e9 ff ff       	call   80103980 <myproc>
  fileclose(f);
...
80104fbe:	e8 ad fa ff ff       	call   80104a70 <argint>
...
80104fe8:	e8 d3 fa ff ff       	call   80104ac0 <argptr>
...
8010502f:	e8 fc fa ff ff       	call   80104b30 <argstr>
...
80105048:	e8 e3 fa ff ff       	call   80104b30 <argstr>
...
8010517f:	e8 ac f9 ff ff       	call   80104b30 <argstr>
...
801051bd:	58                   	pop    %eax
801051be:	5a                   	pop    %edx
801051bf:	68 64 7c 10 80       	push   $0x80107c64
...
801051d8:	68 63 7c 10 80       	push   $0x80107c63
...
80105232:	e8 79 f5 ff ff       	call   801047b0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010535f:	e8 cc f7 ff ff       	call   80104b30 <argstr>
...
80105378:	e8 f3 f6 ff ff       	call   80104a70 <argint>
...
801053c7:	74 23                	je     801053ec <sys_open+0x9c>
  struct proc *curproc = myproc();
801053c9:	e8 b2 e5 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105417:	e8 04 f8 ff ff       	call   80104c20 <create>
    if(ip == 0){
...
801054a4:	e8 87 f6 ff ff       	call   80104b30 <argstr>
...
80105504:	e8 27 f6 ff ff       	call   80104b30 <argstr>
...
80105519:	e8 52 f5 ff ff       	call   80104a70 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010552e:	e8 3d f5 ff ff       	call   80104a70 <argint>
     argint(1, &major) < 0 ||
...
80105585:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105588:	e8 f3 e3 ff ff       	call   80103980 <myproc>
...
8010559d:	e8 8e f5 ff ff       	call   80104b30 <argstr>
...
80105645:	e8 e6 f4 ff ff       	call   80104b30 <argstr>
...
80105661:	e8 0a f4 ff ff       	call   80104a70 <argint>
...
80105680:	e8 2b f1 ff ff       	call   801047b0 <memset>
...
801056aa:	e8 31 f3 ff ff       	call   801049e0 <fetchint>
...
801056c8:	e8 53 f3 ff ff       	call   80104a20 <fetchstr>
...
80105731:	e8 8a f3 ff ff       	call   80104ac0 <argptr>
...
80105757:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105759:	e8 22 e2 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
{
  return fork();
801057f0:	e9 2b e3 ff ff       	jmp    80103b20 <fork>
...
80105803:	83 ec 08             	sub    $0x8,%esp
  exit();
80105806:	e8 d5 e5 ff ff       	call   80103de0 <exit>
...
{
  return wait();
80105810:	e9 fb e6 ff ff       	jmp    80103f10 <wait>
...
8010582c:	e8 3f f2 ff ff       	call   80104a70 <argint>
...
8010583e:	e8 6d e9 ff ff       	call   801041b0 <kill>
...
80105896:	e8 05 e2 ff ff       	call   80103aa0 <growproc>
...
801058cd:	e8 9e f1 ff ff       	call   80104a70 <argint>
...
801058e5:	e8 06 ee ff ff       	call   801046f0 <acquire>
  ticks0 = ticks;
...
8010590d:	e8 7e e7 ff ff       	call   80104090 <sleep>
  while(ticks - ticks0 < n){
...
8010591f:	73 2f                	jae    80105950 <sys_sleep+0x90>
    if(myproc()->killed){
80105921:	e8 5a e0 ff ff       	call   80103980 <myproc>
...
80105935:	e8 56 ed ff ff       	call   80104690 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105958:	e8 33 ed ff ff       	call   80104690 <release>
  return 0;
...
801059a0 <sys_getreadcount>:

int sys_getreadcount(void) {
	return readcount;
}
801059a0:	a1 58 3f 11 80       	mov    0x80113f58,%eax
801059a5:	c3                   	ret    
801059a6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801059ad:	8d 76 00             	lea    0x0(%esi),%esi

801059b0 <sys_getopenfilecount>:

int
sys_getopenfilecount(void){
801059b0:	55                   	push   %ebp
801059b1:	89 e5                	mov    %esp,%ebp
801059b3:	83 ec 08             	sub    $0x8,%esp
	int count =0;
	struct proc *curproc = myproc();
801059b6:	e8 c5 df ff ff       	call   80103980 <myproc>
	struct file *f;
	for (int i=0; i<NOFILE; i++){
801059bb:	8d 50 28             	lea    0x28(%eax),%edx
801059be:	8d 48 68             	lea    0x68(%eax),%ecx
	int count =0;
...
801059c7:	90                   	nop
		...
		if (f){
			count++;
801059c8:	83 3a 01             	cmpl   $0x1,(%edx)
801059cb:	83 d8 ff             	sbb    $0xffffffff,%eax
	for (int i=0; i<NOFILE; i++){
801059ce:	83 c2 04             	add    $0x4,%edx
801059d1:	39 ca                	cmp    %ecx,%edx
801059d3:	75 f3                	jne    801059c8 <sys_getopenfilecount+0x18>
		}
	}
	return count;
}
...
80105a17:	c7 04 c5 c2 3f 11 80 	movl   $0x8e000008,-0x7feec03e(,%eax,8)
80105a1e:	08 00 00 8e 
80105a22:	66 89 14 c5 c0 3f 11 	mov    %dx,-0x7feec040(,%eax,8)
80105a29:	80 
80105a2a:	c1 ea 10             	shr    $0x10,%edx
80105a2d:	66 89 14 c5 c6 3f 11 	mov    %dx,-0x7feec03a(,%eax,8)
80105a34:	80 
  for(i = 0; i < 256; i++)
...
80105a47:	c7 05 c2 41 11 80 08 	movl   $0xef000008,0x801141c2
80105a4e:	00 00 ef 
  initlock(&tickslock, "time");
80105a51:	68 a9 7c 10 80       	push   $0x80107ca9
80105a56:	68 80 3f 11 80       	push   $0x80113f80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a5b:	66 a3 c0 41 11 80    	mov    %ax,0x801141c0
80105a61:	c1 e8 10             	shr    $0x10,%eax
80105a64:	66 a3 c6 41 11 80    	mov    %ax,0x801141c6
  initlock(&tickslock, "time");
80105a6a:	e8 b1 ea ff ff       	call   80104520 <initlock>
}
...
80105a8b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a8f:	b8 c0 3f 11 80       	mov    $0x80113fc0,%eax
...
80105ad4:	ff 24 85 50 7d 10 80 	jmp    *-0x7fef82b0(,%eax,4)
...
80105adf:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105ae0:	e8 5b c7 ff ff       	call   80102240 <ideintr>
    lapiceoi();
...
80105af3:	e8 88 de ff ff       	call   80103980 <myproc>
...
80105b19:	e8 62 de ff ff       	call   80103980 <myproc>
...
80105b80:	e8 db dd ff ff       	call   80103960 <cpuid>
...
80105bb5:	68 0c 7d 10 80       	push   $0x80107d0c
80105bba:	e8 e1 aa ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105bbf:	83 c4 20             	add    $0x20,%esp
80105bc2:	e8 b9 dd ff ff       	call   80103980 <myproc>
80105bc7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bce:	e8 ad dd ff ff       	call   80103980 <myproc>
...
80105be4:	0f 85 3e ff ff ff    	jne    80105b28 <trap+0x78>
    yield();
80105bea:	e8 51 e4 ff ff       	call   80104040 <yield>
...
80105bff:	e8 5c dd ff ff       	call   80103960 <cpuid>
80105c04:	57                   	push   %edi
80105c05:	56                   	push   %esi
80105c06:	50                   	push   %eax
80105c07:	68 b4 7c 10 80       	push   $0x80107cb4
80105c0c:	e8 8f aa ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105c11:	e8 fa cc ff ff       	call   80102910 <lapiceoi>
    break;
...
80105c45:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c48:	e8 63 ef ff ff       	call   80104bb0 <syscall>
    if(myproc()->killed)
...
80105c63:	5d                   	pop    %ebp
      exit();
80105c64:	e9 77 e1 ff ff       	jmp    80103de0 <exit>
...
80105c75:	e8 96 cc ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c7a:	e8 01 dd ff ff       	call   80103980 <myproc>
...
80105c8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105c90:	e8 3b cb ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80105c95:	e8 76 cc ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c9a:	e8 e1 dc ff ff       	call   80103980 <myproc>
...
80105cc0:	68 80 3f 11 80       	push   $0x80113f80
80105cc5:	e8 26 ea ff ff       	call   801046f0 <acquire>
      wakeup(&ticks);
80105cca:	c7 04 24 60 3f 11 80 	movl   $0x80113f60,(%esp)
      ticks++;
80105cd1:	83 05 60 3f 11 80 01 	addl   $0x1,0x80113f60
      wakeup(&ticks);
80105cd8:	e8 73 e4 ff ff       	call   80104150 <wakeup>
      release(&tickslock);
80105cdd:	c7 04 24 80 3f 11 80 	movl   $0x80113f80,(%esp)
80105ce4:	e8 a7 e9 ff ff       	call   80104690 <release>
...
{
  if(!uart)
80105d40:	a1 c0 47 11 80       	mov    0x801147c0,%eax
...
80105dc7:	74 78                	je     80105e41 <uartinit+0xd1>
  uart = 1;
80105dc9:	c7 05 c0 47 11 80 01 	movl   $0x1,0x801147c0
80105dd0:	00 00 00 
...
80105ddc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ddf:	bf d0 7d 10 80       	mov    $0x80107dd0,%edi
80105de4:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105de9:	6a 00                	push   $0x0
80105deb:	6a 04                	push   $0x4
80105ded:	e8 8e c6 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105e50 <uartputc>:
  if(!uart)
80105e50:	a1 c0 47 11 80       	mov    0x801147c0,%eax
...
80105e75:	e8 b6 ca ff ff       	call   80102930 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
...
801069c9:	e8 f2 ba ff ff       	call   801024c0 <kfree>
      *pte = 0;
...
801069df:	68 86 77 10 80       	push   $0x80107786
...
80106a6e:	e8 0d bc ff ff       	call   80102680 <kalloc>
...
80106a85:	e8 26 dd ff ff       	call   801047b0 <memset>
...
80106acd:	68 d8 7d 10 80       	push   $0x80107dd8
...
80106ae3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106ae6:	e8 75 ce ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106b70:	a1 c4 47 11 80       	mov    0x801147c4,%eax
...
80106ba4:	0f 84 c2 00 00 00    	je     80106c6c <switchuvm+0xec>
  pushcli();
80106baa:	e8 f1 d9 ff ff       	call   801045a0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106baf:	e8 4c cd ff ff       	call   80103900 <mycpu>
80106bb4:	89 c3                	mov    %eax,%ebx
80106bb6:	e8 45 cd ff ff       	call   80103900 <mycpu>
...
80106bc8:	e8 33 cd ff ff       	call   80103900 <mycpu>
...
80106cab:	77 4b                	ja     80106cf8 <inituvm+0x68>
  mem = kalloc();
80106cad:	e8 ce b9 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106cf2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106cf3:	e9 58 db ff ff       	jmp    80104850 <memmove>
    panic("inituvm: more than a page");
80106cf8:	83 ec 0c             	sub    $0xc,%esp
80106cfb:	68 1d 7e 10 80       	push   $0x80107e1d
...
80106d60:	68 37 7e 10 80       	push   $0x80107e37
...
80106dae:	e8 dd ac ff ff       	call   80101a90 <readi>
...
80106de8:	68 d8 7e 10 80       	push   $0x80107ed8
...
80106e4b:	e8 60 d9 ff ff       	call   801047b0 <memset>
...
80106e79:	76 48                	jbe    80106ec3 <allocuvm+0xc3>
    mem = kalloc();
80106e7b:	e8 00 b8 ff ff       	call   80102680 <kalloc>
...
80106e89:	68 55 7e 10 80       	push   $0x80107e55
...
80106eeb:	68 6d 7e 10 80       	push   $0x80107e6d
...
80106f10:	e8 ab b5 ff ff       	call   801024c0 <kfree>
      return 0;
...
80106fae:	e8 0d b5 ff ff       	call   801024c0 <kfree>
...
80106fc3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106fc4:	e9 f7 b4 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80106fc9:	83 ec 0c             	sub    $0xc,%esp
80106fcc:	68 89 7e 10 80       	push   $0x80107e89
...
80106fe5:	e8 96 b6 ff ff       	call   80102680 <kalloc>
...
80107000:	e8 ab d7 ff ff       	call   801047b0 <memset>
...
8010706b:	a3 c4 47 11 80       	mov    %eax,0x801147c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010709c:	68 9a 7e 10 80       	push   $0x80107e9a
...
80107112:	68 a4 7e 10 80       	push   $0x80107ea4
...
80107170:	e8 db d6 ff ff       	call   80104850 <memmove>
...
801071bc:	e8 ff b2 ff ff       	call   801024c0 <kfree>
      goto bad;
...
801071e7:	68 be 7e 10 80       	push   $0x80107ebe
...
801072a0:	e8 ab d5 ff ff       	call   80104850 <memmove>
    len -= n;
    buf += n;
...
80107331:	b8 e4 47 11 80       	mov    $0x801147e4,%eax
...
8010733b:	89 15 e0 47 11 80    	mov    %edx,0x801147e0
    for (mti=1; mti<N; mti++)
80107341:	eb 08                	jmp    8010734b <sgenrand+0x1b>
80107343:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80107347:	90                   	nop
80107348:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
8010734b:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
80107351:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
80107353:	3d 9c 51 11 80       	cmp    $0x8011519c,%eax
80107358:	75 ee                	jne    80107348 <sgenrand+0x18>
8010735a:	c7 05 60 a4 10 80 70 	movl   $0x270,0x8010a460
80107361:	02 00 00 
}
80107364:	5d                   	pop    %ebp
80107365:	c3                   	ret    
...
80107375:	3d 6f 02 00 00       	cmp    $0x26f,%eax
8010737a:	7f 3d                	jg     801073b9 <genrand+0x49>
    ...
    y = mt[mti++];
8010737c:	8b 0c 85 e0 47 11 80 	mov    -0x7feeb820(,%eax,4),%ecx
80107383:	8d 50 01             	lea    0x1(%eax),%edx
80107386:	89 15 60 a4 10 80    	mov    %edx,0x8010a460
    y ^= TEMPERING_SHIFT_U(y);
8010738c:	89 ca                	mov    %ecx,%edx
8010738e:	c1 ea 0b             	shr    $0xb,%edx
80107391:	31 ca                	xor    %ecx,%edx
    y ^= TEMPERING_SHIFT_S(y) & TEMPERING_MASK_B;
80107393:	89 d0                	mov    %edx,%eax
80107395:	c1 e0 07             	shl    $0x7,%eax
80107398:	25 80 56 2c 9d       	and    $0x9d2c5680,%eax
8010739d:	31 d0                	xor    %edx,%eax
    y ^= TEMPERING_SHIFT_T(y) & TEMPERING_MASK_C;
8010739f:	89 c2                	mov    %eax,%edx
801073a1:	c1 e2 0f             	shl    $0xf,%edx
801073a4:	81 e2 00 00 c6 ef    	and    $0xefc60000,%edx
801073aa:	31 c2                	xor    %eax,%edx
    y ^= TEMPERING_SHIFT_L(y);
801073ac:	89 d0                	mov    %edx,%eax
801073ae:	c1 e8 12             	shr    $0x12,%eax
801073b1:	31 d0                	xor    %edx,%eax

    // Strip off uppermost bit because we want a long,
    // not an unsigned long
    return y & RAND_MAX;
801073b3:	25 ff ff ff 7f       	and    $0x7fffffff,%eax
}
801073b8:	c3                   	ret    
        if (mti == N+1)   /* if sgenrand() has not been called, */
801073b9:	3d 71 02 00 00       	cmp    $0x271,%eax
801073be:	0f 84 d4 00 00 00    	je     80107498 <genrand+0x128>
    mt[0]= seed & 0xffffffff;
801073c4:	31 c0                	xor    %eax,%eax
801073c6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801073cd:	8d 76 00             	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
801073d0:	8b 0c 85 e0 47 11 80 	mov    -0x7feeb820(,%eax,4),%ecx
801073d7:	83 c0 01             	add    $0x1,%eax
801073da:	8b 14 85 e0 47 11 80 	mov    -0x7feeb820(,%eax,4),%edx
801073e1:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
801073e7:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
801073ed:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+M] ^ (y >> 1) ^ mag01[y & 0x1];
801073ef:	89 d1                	mov    %edx,%ecx
801073f1:	83 e2 01             	and    $0x1,%edx
801073f4:	d1 e9                	shr    %ecx
801073f6:	33 0c 85 10 4e 11 80 	xor    -0x7feeb1f0(,%eax,4),%ecx
801073fd:	33 0c 95 fc 7e 10 80 	xor    -0x7fef8104(,%edx,4),%ecx
80107404:	89 0c 85 dc 47 11 80 	mov    %ecx,-0x7feeb824(,%eax,4)
        for (kk=0;kk<N-M;kk++) {
8010740b:	3d e3 00 00 00       	cmp    $0xe3,%eax
80107410:	75 be                	jne    801073d0 <genrand+0x60>
80107412:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            y = (mt[kk]&UPPER_MASK)|(mt[kk+1]&LOWER_MASK);
80107418:	8b 0c 85 e0 47 11 80 	mov    -0x7feeb820(,%eax,4),%ecx
8010741f:	83 c0 01             	add    $0x1,%eax
80107422:	8b 14 85 e0 47 11 80 	mov    -0x7feeb820(,%eax,4),%edx
80107429:	81 e1 00 00 00 80    	and    $0x80000000,%ecx
8010742f:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
80107435:	09 ca                	or     %ecx,%edx
            mt[kk] = mt[kk+(M-N)] ^ (y >> 1) ^ mag01[y & 0x1];
80107437:	89 d1                	mov    %edx,%ecx
80107439:	83 e2 01             	and    $0x1,%edx
8010743c:	d1 e9                	shr    %ecx
8010743e:	33 0c 85 50 44 11 80 	xor    -0x7feebbb0(,%eax,4),%ecx
80107445:	33 0c 95 fc 7e 10 80 	xor    -0x7fef8104(,%edx,4),%ecx
8010744c:	89 0c 85 dc 47 11 80 	mov    %ecx,-0x7feeb824(,%eax,4)
        for (;kk<N-1;kk++) {
80107453:	3d 6f 02 00 00       	cmp    $0x26f,%eax
80107458:	75 be                	jne    80107418 <genrand+0xa8>
        y = (mt[N-1]&UPPER_MASK)|(mt[0]&LOWER_MASK);
8010745a:	8b 0d e0 47 11 80    	mov    0x801147e0,%ecx
80107460:	a1 9c 51 11 80       	mov    0x8011519c,%eax
80107465:	89 ca                	mov    %ecx,%edx
80107467:	25 00 00 00 80       	and    $0x80000000,%eax
8010746c:	81 e2 ff ff ff 7f    	and    $0x7fffffff,%edx
80107472:	09 d0                	or     %edx,%eax
        mt[N-1] = mt[M-1] ^ (y >> 1) ^ mag01[y & 0x1];
80107474:	89 c2                	mov    %eax,%edx
80107476:	83 e0 01             	and    $0x1,%eax
80107479:	d1 ea                	shr    %edx
8010747b:	33 15 10 4e 11 80    	xor    0x80114e10,%edx
80107481:	33 14 85 fc 7e 10 80 	xor    -0x7fef8104(,%eax,4),%edx
80107488:	89 15 9c 51 11 80    	mov    %edx,0x8011519c
8010748e:	ba 01 00 00 00       	mov    $0x1,%edx
80107493:	e9 ee fe ff ff       	jmp    80107386 <genrand+0x16>
    mt[0]= seed & 0xffffffff;
80107498:	b8 e4 47 11 80       	mov    $0x801147e4,%eax
8010749d:	b9 9c 51 11 80       	mov    $0x8011519c,%ecx
801074a2:	ba 05 11 00 00       	mov    $0x1105,%edx
801074a7:	c7 05 e0 47 11 80 05 	movl   $0x1105,0x801147e0
801074ae:	11 00 00 
    for (mti=1; mti<N; mti++)
801074b1:	eb 08                	jmp    801074bb <genrand+0x14b>
801074b3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801074b7:	90                   	nop
801074b8:	83 c0 04             	add    $0x4,%eax
        mt[mti] = (69069 * mt[mti-1]) & 0xffffffff;
801074bb:	69 d2 cd 0d 01 00    	imul   $0x10dcd,%edx,%edx
801074c1:	89 10                	mov    %edx,(%eax)
    for (mti=1; mti<N; mti++)
801074c3:	39 c1                	cmp    %eax,%ecx
801074c5:	75 f1                	jne    801074b8 <genrand+0x148>
801074c7:	e9 f8 fe ff ff       	jmp    801073c4 <genrand+0x54>
801074cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

801074d0 <random_at_most>:
...
801074d9:	53                   	push   %ebx
    bin_size = num_rand / num_bins,
801074da:	bb 00 00 00 80       	mov    $0x80000000,%ebx
    num_bins = (unsigned long) max + 1,
801074df:	8d 48 01             	lea    0x1(%eax),%ecx
    bin_size = num_rand / num_bins,
801074e2:	89 d8                	mov    %ebx,%eax
801074e4:	f7 f1                	div    %ecx
801074e6:	89 c6                	mov    %eax,%esi
  long x;
  do {
   x = genrand();
  }
...
801074e8:	29 d3                	sub    %edx,%ebx
801074ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
   x = genrand();
801074f0:	e8 7b fe ff ff       	call   80107370 <genrand>
  while (num_rand - defect <= (unsigned long)x);
801074f5:	39 d8                	cmp    %ebx,%eax
801074f7:	73 f7                	jae    801074f0 <random_at_most+0x20>

  // Truncated division is intentional
  return x/bin_size;
801074f9:	31 d2                	xor    %edx,%edx
}
801074fb:	5b                   	pop    %ebx
  return x/bin_size;
801074fc:	f7 f6                	div    %esi
}
801074fe:	5e                   	pop    %esi
801074ff:	5d                   	pop    %ebp
80107500:	c3                   	ret    
